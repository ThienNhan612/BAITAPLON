    ...
    <div class="products-view mt-4 container">
        <form method="POST" @submit.prevent="addBook">
            <div class="form-group row ">
                <label for="name-product" class="col-sm-2 col-form-label font-weight-bold">Tên sách</label>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                <label for="price-product" class="col-sm-2 col-form-label font-weight-bold">Category</label>
                <div class="col-sm-10">
                    <input type="text" v-model="posts.category" class="form-control" >
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" @click="getNameFileImg">Thêm sách</button>
                </div>
            </div>
        </form>
    </div>
...
export default {
    ...
    methods: {
        ...
        addBook() {
            axios.post("http://localhost:3000/book/store", this.posts)
            .then(res => {
